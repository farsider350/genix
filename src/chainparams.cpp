...
//        consensus.nPowDGWHeight = 1000;
        ...
        // Genix BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
...
public:
    CTestNetParams() {
        ...
        consensus.BIP34Height = 1;
        consensus.BIP34Hash = uint256S("00000f40e3257ca260a57d2afdf1207a1760dcf54d376ec232ba4276cd7ab711");
